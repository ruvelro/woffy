...
## 2026-07-21 — v3.1.2
- Added `woffy telegram set-mode {all|errors|success}` to change the Telegram notification level alone, without re-entering the bot token or chat id.
- Added a matching control on the web panel's Integrations page to change the notification mode without resubmitting the token.
