...
SCRIPT_URL="https://raw.githubusercontent.com/tuusuario/woffy/main/woffy.sh"

if [ "$1" != "-s" ] || [ $# -lt 3 ]; then
  echo "Uso: $0 -s EMAIL PASSWORD [TELEGRAM_TOKEN CHAT_ID THREAD_ID]"
  exit 1
fi
...
echo "✅ woffy instalado correctamente."